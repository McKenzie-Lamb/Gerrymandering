...
def create_graph(daShapefile, rm_discontiguos = False, get_small_graph = False):
    ...
    with fiona.open(daShapefile[0]) as shapes:
        ...
        for feat in shapes:
            ...
            graph.add_node(int(tract_id), polygon=tracts, pop=properties[0], rep=properties[1], dem=properties[2], pos=(positionx, positiony))
            count += 1
...
# Files path                            
daShapefile14 = (r"E:\Projects\Gerrymandering\Gerrymandering\Drawing Wisconsin by Ward\Wards_fall_2014.shape\Wards_Final_Geo_111312_2014_ED.shp", 14)
...
graph = create_graph(daShapefile17, rm_discontiguos = True)
