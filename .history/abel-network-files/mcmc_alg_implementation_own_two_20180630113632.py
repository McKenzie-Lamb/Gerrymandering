        ...
        for v in range(len(list_to_swap[l])):
            for l_two in range(len(list_to_swap)):
                ...
                for v_two in range(len(list_to_swap[l_two])):
                    print(gt.shortest_path(graph, graph.vertex(list_to_swap[l][v]), graph.vertex(list_to_swap[l_two][v_two]))[0])
                    if len(gt.shortest_path(graph, graph.vertex(list_to_swap[l][v]), graph.vertex(list_to_swap[l_two][v_two]))[0]) > 2:
                        propose.append(list_to_swap[l])
    return list_to_swap
