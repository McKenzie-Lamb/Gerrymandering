...
def adjust_color(districts_graphs, color, ring_color, niter_type = 'first', ring_colors_dict = None, district_of_vertex):
...
for i in districts_graphs:
    if i.graph_properties["dem_vote"] > i.graph_properties["rep_vote"]:
        ...
        rep_seats += 1
gt.graph_draw(graph, vertex_color = ring_color, vertex_fill_color = color, vertex_text = graph.vp.cd,
