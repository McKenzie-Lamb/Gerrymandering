...
for i in graph.vertices():
    ...
    color[graph.vertex(i)] = (255, 0, 0, 1) if blocks[i] == 1 else (0,0,255,1)


gt.graph_draw(graph, bg_color = (255,255,255,1), vertex_bgcolor=color, pos=graph.vp.pos,vertex_text=graph.vertex_index, output='abel-network-files/tmp.png')