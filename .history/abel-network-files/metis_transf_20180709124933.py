...
gt.graph_draw(graph, pos=graph.vp.pos, vertex_fill_color=color, vertex_text=name, output=str(main_folder / 'tmp_metis_init.png'))
...
gt.graph_draw(graph, pos=graph.vp.pos, vertex_text=name, vertex_fill_color = color, output=str(main_folder / 'tmp_metis_fin.png'))