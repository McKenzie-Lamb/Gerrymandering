...
graph.vp.color = color
graph.vp.ring_color = ring_color
# Init variables
district_total_no = 2
...
gt.graph_draw(graph, vertex_fill_color = graph.vp.color, vertex_color = graph.vp.ring_color,
...
for i in range(10):
    ...
    for j in districts_graphs:
        print(j.gp.dem_vote, j.gp.rep_vote)
