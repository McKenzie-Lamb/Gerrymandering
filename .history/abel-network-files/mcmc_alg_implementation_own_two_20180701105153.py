...
gt.graph_draw(graph, pos=graph.vp.pos,
              output=str(main_folder / ('tmp.png')),
              bg_color=(255, 255, 255, 1), vertex_text=graph.vertex_index,vertex_halo = True, vertex_halo_color=ring_color, vertex_fill_color=color)